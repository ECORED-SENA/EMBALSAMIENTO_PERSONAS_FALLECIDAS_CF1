...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.mb-5
      ...
      .col-10.col-lg-4
        figure
          img.mx-auto(src='@/assets/curso/tema3/img1.jpg', alt='Medidas de bioseguridad', style='width:420px;')
      ...
      .col-lg-12.px-md-5
        ...
        .row.justify-content-center.mb-4
          .col-10.col-lg-5.mb-4.mb-lg-0
            figure
              img.mx-auto(src='@/assets/curso/tema3/img2.jpg', alt='Capacitación salud ocupacional', style='width:505px;')
          .col-lg-7
        ...
        .row.justify-content-center.mb-5
          p.mb-0 En Colombia, rigen actualmente varias normas sobre bioseguridad y cuidado en el trabajo, entre ellas están: 
    ...
    .bloque-texto-a.color-primario.p-4.p-lg-5.mb-5 
      .row.m-0.align-items-center.justify-content-between
        .col-lg-3.mb-4.mb-lg-0.align-self-center
          figure
            img.mx-auto(src='@/assets/curso/tema3/img3.svg', alt='imagen ambiental',style='width:250px;')
        .col-lg-9
          .bloque-texto-a__texto.p-4.p-lg-5
            p.mb-4.mb-lg-3 Apreciado aprendiz, el Ministerio de Trabajo de Colombia ha desarrollado una #[strong “Guía para trabajadores expuestos a riesgos biológicos” (2018).] Está invitado a identificar las herramientas y recomendaciones sugeridas en los entornos laborales que presentan alta exposición a riesgo biológico. Haga clic en el presente ícono para ir al texto.
            .contenedorLink
              .row
                .col-auto
    ...
    .row.justify-content-center.fondo3
      .col-lg-12.px-md-5
        ...
        .row.justify-content-center.mb-5
          ...
          p.mb-0 Existen dos mecanismos de barrera contundentes, que permiten minimizar los riesgos de contraer enfermedades de riesgo biológico. Ellos son:
          ...
          .tarjeta--container.row.mb-4
            .col-md.tarjeta.color-secundario.p-5(style='background-color:#EEEEF2 ')
              .row.justify-content-center.mb-4
                .col-4
                  figure
                    img(src='@/assets/curso/tema3/icon5.svg', alt='icono que acompaña')
            ...
            .col-md.tarjeta.color-primario.p-5(style='background-color: #A6DAD7')
              .row.justify-content-center.mb-4
                .col-4
                  figure
                    img(src='@/assets/curso/tema3/icon6.svg', alt='icono que acompaña')
    ...
    .tarjeta.fondo-slider.p-4.mb-5
      SlyderA
        .row(style='justify-content: space-evenly')
          .col-lg-5.mb-4.mb-md-0.align-self-center.p-lg-0
            .cajon-b.color-primario.abajo-derecha.p-4.p-lg-3.mb-0
          ...
          .col-10.col-md-5.align-self-center
            figure
              img.mx-auto(src='@/assets/curso/tema3/img5.jpg', alt='Los malos hábitos bajan las defensas', style=' width: 456px;')

        .row(style='justify-content: space-evenly')
          .col-10.col-lg-5.align-self-center
            figure.mb-4
              img.mx-auto(src='@/assets/curso/tema3/img6.jpg', alt='Microorganismos nocivos' style='width: 456px;')
          .col-lg-5.mb-4.mb-lg-0.align-self-center.p-lg-0
            .cajon-b.color-primario.p-4.p-lg-3
        ...
        .row(style='justify-content: space-evenly')
          .col-lg-5.mb-4.mb-md-0.align-self-center.p-lg-0
            p.mb-3 Los órganos o tejidos que sirven como barreras de defensa para el cuerpo son: las amígdalas, la glándula timo, sistema linfático (ganglios), bazo y la médula ósea. 
            .cajon-b.color-primario.abajo-derecha-p-4.p-lg-3.mb-0
          ...
          .col-10.col-lg-5.align-self-center
            figure
              img.mx-auto(src='@/assets/curso/tema3/img7.jpg', alt='Barreras de defensa', style=' width: 456px;')

        .row(style='justify-content: space-evenly')
          .col-10.col-lg-5.align-self-center.mb-4.mb-lg-0
            figure
              img.mx-auto(src='@/assets/curso/tema3/img8.jpg', alt='Sistema inmune de defensa', style='width: 456px')
        ...
        .row(style='justify-content: space-evenly')
          ...
          .col-10.col-lg-5.align-self-center
            figure
              img.mx-auto(src='@/assets/curso/tema3/img9.jpg', alt='Combatir enfermedades', style=' width: 456px;')
        
        .row(style='justify-content: space-evenly')
          .col-10.col-lg-4.align-self-center.mb-4.mb-lg-0
            figure
              img.mx-auto(src='@/assets/curso/tema3/img10.jpg', alt='Enfermedad infectocontagiosa', style='width: 456px;')
          .col-lg-6.align-self-center.p-lg-0
            .cajon-b.color-primario.p-4.p-lg-3.mb-2
            ...
            .row.justify-content-center
              .col-auto
                figure
                  img.mx-auto(src='@/assets/curso/tema3/img11.svg', alt='', style='width:590px;')
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-4.align-self-center
        figure
          img.mx-auto(src='@/assets/curso/tema3/img12.jpg', alt='Protección personal según el area', style='width:460px;')

    .row
      .col-lg-12.p-0
        .tarjeta-avatar-b.mb-5
          .tarjeta-avatar-b__img(style='min-width:15%')
            img.mx-auto(src='@/assets/curso/tema3/icon7.svg' alt='AvatarTop', style='width:160px;')
    ...
    .bloque-texto-a.color-primario.p-4.p-md-4.mb-5 
      .row.m-0.align-items-center.justify-content-between
        ...
        .col-lg-3.mb-4.mb-lg-0.align-self-center
          figure
            img.mx-auto(src='@/assets/curso/tema3/img13.svg', alt='imagen ambiental', style='width:245px;')


    .row.justify-content-center
      .col-6.col-lg-4.mb-4.mb-lg-0
          figure
            img.mx-auto(src='@/assets/curso/tema3/img14.svg', alt='imagen ambiental', style='width: 420px;')
      .col-lg-8.mb-5
        LineaTiempoD.color-primario
          ...
          .row.justify-content-center(numero="4" titulo="Protección respiratoria")
            .col-11
              .row.justify-content-center.mt-3
                .col-md-2.linea-custom.align-self-center(style='text-align: center;')
                  figure
                    img.mx-auto(src='@/assets/curso/tema3/img18.svg', alt='Protección respiratoria')
                .col-md-10.mb-4.mb-md-0
                  p.mb-0 Es fundamental tener siempre tapabocas especializados para la protección, porque existen micropartículas de elementos patógenos que se albergan en el aire y penetran a través de la respiración. Se recomienda el uso de mascarillas tipo N95. 
            .col-11
          ...
          .row.justify-content-center.mt-3(numero="5" titulo="Guantes")
            .col-md-2.linea-custom.align-self-center(style='text-align: center;')
              figure
                img.mx-auto(src='@/assets/curso/tema3/img19.svg', alt='Guantes', style='width:68px;')
            .col-md-9.mb-4.mb-md-0
              p.mb-0 Se recomienda que sean de material resistente, como el nitrilo o la goma. Los de látex no se recomiendan para el uso funerario, pues el material es poroso, lo que genera que el líquido o pequeñas partículas se filtren más rápido. Se usan para cubrir por completo la mano y los dedos hasta hacer contacto con el área de la muñeca que aísla la bata, protegiendo así por completo las extremidades superiores. Se tienen que cambiar cuando se rompan.
          
    
    .row
      .col-lg-12.p-3(style='background-color: #1D272B; border-radius: 10px;')
        h4.text-center.text-white.mb-0  A continuación, se presenta el orden adecuado para la implementación de estos elementos de protección personal
      
    .row.mb-5
      .col-lg-12.px-0
        figure
          img.mx-auto(src='@/assets/curso/tema3/img20.svg', alt='', style='')
    ...
    PasosA.color-primario.mb-4(tipo="n")
        ...
        .col-auto
          .tarjeta-avatar-b.mb-2
            .tarjeta-avatar-b__img
              img(src='@/assets/curso/tema3/icon8.svg' alt='AvatarTop')
            .tarjeta
              .p-4
      ...
      .row.justify-content-end
        .col-auto
          .tarjeta-avatar-b.mb-2
            ...
            .tarjeta-avatar-b__img
              img(src='@/assets/curso/tema3/icon9.svg' alt='AvatarTop')
            
      .row
        .col-auto
          .tarjeta-avatar-b.mb-2
            .tarjeta-avatar-b__img
              img(src='@/assets/curso/tema3/icon10.svg' alt='AvatarTop')
            .tarjeta
              .p-4
                h3 Retirar gafas
      ...
      .row.justify-content-end
        .col-auto
          .tarjeta-avatar-b.mb-2
            ...
            .tarjeta-avatar-b__img
              img(src='@/assets/curso/tema3/icon11.svg' alt='AvatarTop')
      .row
        .col-auto
          .tarjeta-avatar-b.mb-2
            .tarjeta-avatar-b__img
              img(src='@/assets/curso/tema3/icon12.svg' alt='AvatarTop')
            .tarjeta
              .p-4
                h3 Limpiar pijama
      ...
      .row
        .col-auto
          .tarjeta-avatar-b.mb-2
            .tarjeta-avatar-b__img
              img(src='@/assets/curso/tema3/icon14.svg' alt='AvatarTop')
            .tarjeta
              .p-4
                h3 Lavar las manos
      ...
      .col-lg-8.py-lg-5
        .row.justify-content-center
          .col-lg-auto.align-self-center
            figure.resnone
              img.mx-auto(src='@/assets/curso/tema3/icono15.svg', alt='imagen ambiental', style='width: 66px;')
            figure.resnone-lg
              img.mx-auto(src='@/assets/curso/tema3/img21.jpg', alt='imagen ambiental', style='width: 480px;')
          .col-auto.col-lg.p-4.p-lg-1
            .p-2(style='border-left: 4px solid #1D272B;')
              p.mb-0
                b El lavado de las manos incluye la palma, el dorso, los dedos y las uñas; 
                b-none  para estas últimas  
                b(style="color: #008F85;") se recomiendan que estén cortas, sin esmalte y limpias. 
                b Para el lavado eficiente de las manos se debe usar agua limpia y jabón desinfectante. 
                b-none Se le sugiere observar el siguiente recurso de aprendizaje para que perciba un buen lavado de manos.
